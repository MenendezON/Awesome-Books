...
class ListOfBooks {
  ...
  setLocalStorage = (newBooks) =>
    localStorage.setItem("datas", JSON.stringify(newBooks));
...
const generateContactForm = () => {
  ...
  item1.innerHTML =
    '<strong>Our e-mail : </strong><a href="mailto:contact@awesomebooks.org">contact@awesomebooks.org</a>';
  const item2 = document.createElement("li");
  item2.innerHTML =
    '<strong>Our phone number: </strong><a href="tel:+221 78 012 3456">+221 78 012 3456</a>';
  const item3 = document.createElement("li");
  item3.innerHTML =
    "<strong>Our address: </strong>Street name 22, 84503 City, Country";
